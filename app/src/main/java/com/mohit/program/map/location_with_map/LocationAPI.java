...
public class LocationAPI {
    ...
    private Location updateLocationUI() {
        if (mCurrentLocation != null) {
            Toast.makeText(activity, mCurrentLocation.getLatitude() + "" + "::" + mCurrentLocation.getLongitude() + "", Toast.LENGTH_LONG).show();
